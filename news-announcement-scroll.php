...
function news_announcement_widget_control() 
{
	...
	echo 'click here</a>';
	echo '<br><br><a target="_blank" href="http://www.gopiplus.com/work/2011/01/01/news-announcement-scroll/">';
	echo 'www.gopiplus.com</a></p>';
}


function news_announcement_plugins_loaded()
{
  	register_sidebar_widget(__('News announcement scroll'), 'widget_news_announcement');   
	
	if(function_exists('register_sidebar_widget')) 
	{
		register_sidebar_widget('News announcement scroll', 'widget_news_announcement');
	}
	
	if(function_exists('register_widget_control')) 
	{
		register_widget_control(array('News announcement scroll', 'widgets'), 'news_announcement_widget_control');
	} 
}
